        ...
        <Card className="p-4 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 rounded-lg shadow-sm">
            <div>
                ...
                <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="text-base font-semibold text-gray-900 dark:text-white">점검정비명세서 일괄발송</h3>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 mb-4">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3 text-center border border-gray-200 dark:border-gray-700">
                        <div className="text-2xl font-bold text-gray-900 dark:text-white mb-1">{todaySentCount}</div>
                ...
                <div className="flex items-center justify-between gap-2">
                    <Button
                        ...
                        size="sm"
                        onClick={onViewAll}
                        className="text-xs px-3 border-gray-200 bg-gray-50 hover:bg-gray-100 text-gray-700 flex-1"
                    >
                    ...
                    <Button
                        size="sm"
                        onClick={onBulkSend}
                        className="bg-blue-500 hover:bg-blue-600 text-white text-xs px-3 flex-1"
                    >
